...
static constexpr uint8_t STANDARD_MESSAGE_TYPE = 0;
static constexpr uint8_t WARMUP_MESSAGE_TYPE   = 1;

static constexpr int64_t DEFAULT_TIMESTAMP = std::numeric_limits<int64_t>::min ();
