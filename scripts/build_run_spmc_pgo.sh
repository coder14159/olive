...
cd $base_dir && make PGO_PROFILE=1 $profile_bin_dir/spmc_server --jobs $jobs
cd $base_dir && make PGO_PROFILE=1 $profile_bin_dir/spmc_client --jobs $jobs
...
cd $base_dir && make PGO_RELEASE=1 $release_bin_dir/spmc_server --jobs $jobs
cd $base_dir && make PGO_RELEASE=1 $release_bin_dir/spmc_client --jobs $jobs
