...
$(BIN_DIR)/spsc_server: Makefile tools/spsc_server/spsc_server.cpp $(LIB_FILE_PATH) | $(BIN_DIR)
	$(COMPILER) $(CXXFLAGS) -I$(CXXOPTS_DIR) tools/spsc_server/spsc_server.cpp -L$(LIB_DIR) -L$(BOOST_LIB_DIR) -lspmc $(LIB_BOOST_LOG) $(LIB_BOOST_SYSTEM) -o $@
...
$(BIN_DIR)/remove_shared_memory: Makefile tools/remove_shared_memory/remove_shared_memory.cpp $(LIB_FILE_PATH) | $(BIN_DIR)
	$(COMPILER) $(CXXFLAGS)  -I$(CXXOPTS_DIR) tools/remove_shared_memory/remove_shared_memory.cpp -L$(BOOST_LIB_DIR) $(LIB_BOOST_LOG) $(LIB_BOOST_SYSTEM) -o $@
